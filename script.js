// --- PLAYLIST ---
const playlist = [
    { title: "1. I Don't Want To Sleep", file: "imgs/song1.mp3", cover: "imgs/Capa_01.png" },
    { title: "2. Chill Vibes",           file: "imgs/song2.mp3", cover: "imgs/EmBreve_Capa2.png"},
    { title: "3. Fantasy World",         file: "imgs/song3.mp3", cover: "imgs/EmBreve_Capa2.png"},
    { title: "4. Cool Mood",             file: "imgs/song4.mp3", cover: "imgs/EmBreve_Capa2.png"},
    { title: "5. Lo-Fi Study",           file: "imgs/song5.mp3", cover: "imgs/EmBreve_Capa2.png"}
];
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelectorAll('.project-media img').forEach(img => {
        img.addEventListener('click', () => {
            const caption = img.alt || img.closest('.project-card')?.querySelector('.project-title')?.innerText || "";
            openLightbox(img.src, caption);
        });
    });
